...
class DamageNumber:
    def __init__(self, font, position, number, lifetime=60, isCrit=False):
        self.font = font
    ...
    def draw(self, screen):
        draw_text(screen, font=self.font, text=str(self.number), color=(255,255,255), x=self.position.x, y=self.position.y, alpha=self.alpha)